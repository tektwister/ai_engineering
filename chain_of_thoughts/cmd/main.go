...
import (
	...
	"github.com/chain-of-thoughts/internal/adapters/providers"
	"github.com/chain-of-thoughts/internal/core"
...
func main() {
	...
	// Get API key and provider from env
	...
	provider, err := providers.Create(providerName, config)
	if err != nil {
